...
const CreateRestro = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-orange-50 p-4 -mt-4 -mb-10 ">
      <div className="w-full max-w-2xl mb-4">
        {/* Header with orange accent */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center mb-4">
            <div className="w-12 h-1 bg-orange-500 rounded-full mr-3"></div>
            <span className="text-orange-600 font-medium">CREATE RESTAURANT</span>
        ...
        <form
          ...
          className="bg-white rounded-2xl shadow-lg p-6 sm:p-18 border border-orange-100 overflow-hidden border border-orange-100 transition-all duration-300 hover:shadow-2xl"
        >
          <div className="space-y-6">
            {/* Restaurant Name */}
            <div>
              <label className="block text-md font-medium text-gray-700 mb-1 flex items-center">
                Restaurant Name
