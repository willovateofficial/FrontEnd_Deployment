      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <button
            ...
            className={`w-full py-3 text-white font-medium rounded-lg transition-all ${tableNumber.trim() && !isGenerating
        ...
        <div className="px-4 pb-6 text-center text-xs text-gray-500">
          Note: This QR code will direct customers to your table ordering page.
        </div>
      </div>
